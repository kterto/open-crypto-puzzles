...
| Pass 4 wave 7 (2026-09-18): the entropy box of the BIP39 tool, which hashes `entropy.cleanStr`, the characters surviving its base filter, with SHA-256 truncated to 128 bits; every rendering of every structural part under the five character bases and under autodetect | 464 entropies, 57,835,446 ordered pairs | same pipeline, `--wave 7` | 0 match | yes: revealed pair in the first, middle and last entropy, 3 of 3 re-found | 2026-09-18 |
| Pass 4 wave 7b (2026-09-18): the same filtered strings under all 24 digest readings rather than the tool's own SHA-256 truncation, for a tool that filters alike and hashes otherwise | 12,064 entropies, 1,503,705,846 ordered pairs | same pipeline, `--wave 7 --all-digests` | 0 match | yes: 3 of 3 re-found | 2026-09-18 |
